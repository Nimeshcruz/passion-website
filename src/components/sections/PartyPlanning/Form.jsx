                    ...
                    <div className="form">
                        <form onSubmit={handleSubmit(onSubmit)} className='text-xs'>
                            ...
                            <div className='field-row flex flex-col md:flex-row gap-5 mb-6'>
                                ...
                                <div className='field-col flex-1'>
                                    <label className='mb-2 inline-block' htmlFor="people">Type of Party</label>
                                    <input className='block font-light w-[100%] rounded-lg p-3 bg-transparent border border-white' type="text" {...register('people', { required: true })} />
