...
export default function ClubSearch() {
    return (
        <div className="search-box md:p-5 mb-12 lg:mb-0 passion-radio rounded-2xl bg-dark">
            <p className="text-center text-xs font-medium mb-4 hidden lg:block">Search our events calendar and find the perfect club nights and events to attend during your stay in Ibiza!</p>
