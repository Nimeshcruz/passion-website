...
export default function IbizaHero() {
    return (
        <section className="lg:pt-40 pb-40 lg:pb-20 lg:m-3 lg:mt-2 lg:rounded-2xl bg-cover min-h-screen flex items-end" style={{ backgroundImage: `url(${HeroImg})` }}>
            <div className="row w-[100%] md:w-[80%] max-w-[500px] mx-auto flex items-baseline justify-center">
                <div className="col p-10 md:rounded-2xl bg-[rgba(0,0,0,0.55)] bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-6">
                    <div className="content-wrap md:text-center">
                        <h1 className="text-4xl md:text-7xl font-semibold md:font-light uppercase md:capitalize mb-4">What's On <span className="block mt-4">Ibiza</span></h1>
                        <p className="p-x-4 text-base font-light mb-9">Your guide to the best parties <span className="block">and places to go during your stay in Ibiza</span></p>
