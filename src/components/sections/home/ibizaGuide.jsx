...
import CoverImg from "../../../images/ibiza-guide-cover.webp";
...
export default function HomeGuide() {
    return (
        <section className="py-20 relative bg-cover" style={{ backgroundImage: `url(${CoverImg})` }}>
            <div className="row w-[90%] md:w-[80%] mx-auto">
                <div className="title flex justify-between mb-8">
                    <h2 className="text-4xl lg:text-4xl font-semibold lg:font-light mb-1">Ibiza Guide</h2>
                    <GuideCat cat={cat} />
                </div>
