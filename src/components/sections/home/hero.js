...
export default function HomeHero() {
  return (
    <section className="pt-20 md:pt-40 pb-20 m-3 mt-2 rounded-2xl bg-cover min-h-screen flex items-center bg-[url('/images/home-hero.jpg')]">
          ...
          <div className="content-wrap text-center">
            <div className="passion-heart mb-9">
              ...
              <h1 className="text-white text-3xl md:text-4xl font-medium leading-[1.4em]">
                <span className="block">House Music</span>
                <span className="block">from the Heart</span>
              </h1>
            </div>
            <div className="passion-btn mb-12">
              <Link
                href="#"
                className="bg-red text-sm md:text-xs text-white p-4 rounded-md leading-none inline-block"
              >
                Download the App
              </Link>
            </div>
            <div className="passion-radio">
              <div className="fm font-bold text-5xl md:text-6xl tracking-tighter">
                94.4FM
              </div>
